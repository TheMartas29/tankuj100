...
// iPhone — user-supplied "Cosmic Orange" frame overlay. The screenshot sits behind
// the frame's transparent glass opening (measured to 1320×2868); the frame's bezel,
// rounded corners, and dynamic island mask it naturally on top.
  ...
  return (
    <div
      style={{
        ...
        filter: "drop-shadow(0 44px 80px rgba(0,0,0,0.34)) drop-shadow(0 10px 24px rgba(0,0,0,0.18))",
        ...style,
      }}
    >
