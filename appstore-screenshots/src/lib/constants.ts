...
export const SCREEN_RATIO = 1320 / 2868; // bezelless iPhone screen (matches capture size)

// User-supplied iPhone 17 Pro Max frame (public/frames/iphone-frame.png, 1470×3000).
// Glass opening measured from the alpha channel — exactly 1320×2868, matching the
